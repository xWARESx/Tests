...
public class PhysicsTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions = getResources().getStringArray(R.array.physicsQ);
        answers1 = getResources().getStringArray(R.array.physicsAns1);
        answers2 = getResources().getStringArray(R.array.physicsAns2);
        answers3 = getResources().getStringArray(R.array.physicsAns3);
        answers4 = getResources().getStringArray(R.array.physicsAns4);
        answers5 = getResources().getStringArray(R.array.physicsAns5);
        answers6 = getResources().getStringArray(R.array.physicsAns6);
        answers7 = getResources().getStringArray(R.array.physicsAns7);
        answers8 = getResources().getStringArray(R.array.physicsAns8);

        res1 = getString(R.string.physicsRes1);
        res2 = getString(R.string.physicsRes2);
        res3 = getString(R.string.physicsRes3);
    ...
    protected void onPause() {
        ...
        if(sum>=5) ed.putBoolean("physics3", true);
        if(sum<5&&sum>=3) ed.putBoolean("physics2", true);
        if(sum<3) ed.putBoolean("physics1", true);
        ed.apply();
    }
}
