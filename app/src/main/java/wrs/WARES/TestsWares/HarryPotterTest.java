...
public class HarryPotterTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_harry_potter_test);
        checked=true;
        question = (TextView) findViewById(R.id.question1);
        answers = (ListView) findViewById(R.id.answers1);

        questions = getResources().getStringArray(R.array.potterQ);
        answers1 = getResources().getStringArray(R.array.potterAns1);
        answers2 = getResources().getStringArray(R.array.potterAns2);
        answers3 = getResources().getStringArray(R.array.potterAns3);
        answers4 = getResources().getStringArray(R.array.potterAns4);
        answers5 = getResources().getStringArray(R.array.potterAns5);
        answers6 = getResources().getStringArray(R.array.potterAns6);
        answers7 = getResources().getStringArray(R.array.potterAns7);
        answers8 = getResources().getStringArray(R.array.potterAns8);
        answers9 = getResources().getStringArray(R.array.potterAns9);
        answers10 = getResources().getStringArray(R.array.potterAns10);

        res1 = getString(R.string.potterRes1);
        res2 = getString(R.string.potterRes2);
        res3 = getString(R.string.potterRes3);
    ...
    protected void onPause() {
        ...
        if(sum>=8) ed.putBoolean("harry3", true);
        if(sum<8&&sum>=4) ed.putBoolean("harry2", true);
        if(sum<4) ed.putBoolean("harry1", true);
        ed.apply();
    }
}
