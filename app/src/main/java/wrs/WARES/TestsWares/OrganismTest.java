...
public class OrganismTest extends AppCompatActivity {
    ...
    int res = R.drawable.organism_res;
    String res1;
    String res2;
    String res3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_organism_test);
        checked=true;
        question = (TextView) findViewById(R.id.question1);
        answers = (ListView) findViewById(R.id.answers1);

        questions = getResources().getStringArray(R.array.orgQ);
        answers1 = getResources().getStringArray(R.array.orgAns1);
        answers2 = getResources().getStringArray(R.array.orgAns2);
        answers3 = getResources().getStringArray(R.array.orgAns3);
        answers4 = getResources().getStringArray(R.array.orgAns4);
        answers5 = getResources().getStringArray(R.array.orgAns5);
        answers6 = getResources().getStringArray(R.array.orgAns6);
        answers7 = getResources().getStringArray(R.array.orgAns7);
        answers8 = getResources().getStringArray(R.array.orgAns8);
        answers9 = getResources().getStringArray(R.array.orgAns9);
        answers10 = getResources().getStringArray(R.array.orgAns10);

        res1 = getString(R.string.orgRes1);
        res2 = getString(R.string.orgRes2);
        res3 = getString(R.string.orgRes3);
    ...
    protected void onPause() {
        ...
        if(sum>=7) ed.putBoolean("organism3", true);
        if(sum<7&&sum>=4) ed.putBoolean("organism2", true);
        if(sum<4) ed.putBoolean("organism1", true);
        ed.apply();
    }
}
