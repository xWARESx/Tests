...
public class PictureTest extends AppCompatActivity {
    ...
    TextView question;
    ListView answers;
    int res = R.drawable.picture_res;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions = getResources().getStringArray(R.array.pictureQ);
        answers1 = getResources().getStringArray(R.array.pictureAns);

        res1 = getString(R.string.pictureRes1);
        res2 = getString(R.string.pictureRes2);
        res3 = getString(R.string.pictureRes3);
        res4 = getString(R.string.pictureRes4);
