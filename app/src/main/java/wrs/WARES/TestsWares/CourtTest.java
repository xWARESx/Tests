...
public class CourtTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_court_test);
        checked=true;
        question = (TextView) findViewById(R.id.question1);
        answers = (ListView) findViewById(R.id.answers1);

        questions = getResources().getStringArray(R.array.courtQ);
        answers1 = getResources().getStringArray(R.array.courtAns);
        res1 = getString(R.string.courtRes1);
        res2 = getString(R.string.courtRes2);
        res3 = getString(R.string.courtRes3);
        res4 = getString(R.string.courtRes4);
