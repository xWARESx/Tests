...
public class FamousTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_famous_test);
        checked=true;
        question = (TextView) findViewById(R.id.question1);
        answers = (ListView) findViewById(R.id.answers1);

        questions = getResources().getStringArray(R.array.famousQ);
        answers1 = getResources().getStringArray(R.array.famousAns1);
        answers2 = getResources().getStringArray(R.array.famousAns2);
        answers3 = getResources().getStringArray(R.array.famousAns3);
        answers4 = getResources().getStringArray(R.array.famousAns4);
        answers5 = getResources().getStringArray(R.array.famousAns5);
        answers6 = getResources().getStringArray(R.array.famousAns6);
        answers7 = getResources().getStringArray(R.array.famousAns7);
        answers8 = getResources().getStringArray(R.array.famousAns8);
        answers9 = getResources().getStringArray(R.array.famousAns9);
        answers10 = getResources().getStringArray(R.array.famousAns10);

        res1 = getString(R.string.famousRes1);
        res2 = getString(R.string.famousRes2);
        res3 = getString(R.string.famousRes3);
    ...
    protected void onPause() {
        ...
        if(sum>=8) ed.putBoolean("famous3", true);
        if(sum<8&&sum>=4) ed.putBoolean("famous2", true);
        if(sum<4) ed.putBoolean("famous1", true);
        ed.apply();
    }
}
