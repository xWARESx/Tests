...
public class AnimalsTest extends AppCompatActivity {
    ...
    int res = R.drawable.animals_res2;
    String res1;
    String res2;
    String res3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions = getResources().getStringArray(R.array.animalsQ);

        answers1 = getResources().getStringArray(R.array.anAns1);
        answers2 = getResources().getStringArray(R.array.anAns2);
        answers3 = getResources().getStringArray(R.array.anAns3);
        answers4 = getResources().getStringArray(R.array.anAns4);
        answers5 = getResources().getStringArray(R.array.anAns5);
        answers6 = getResources().getStringArray(R.array.anAns6);
        answers7 = getResources().getStringArray(R.array.anAns7);
        answers8 = getResources().getStringArray(R.array.anAns8);
        answers9 = getResources().getStringArray(R.array.anAns9);
        answers10 = getResources().getStringArray(R.array.anAns10);
    ...
    protected void onPause() {
        ...
        if(sum>=7) ed.putBoolean("animals3", true);
        if(sum<7&&sum>=4) ed.putBoolean("animals2", true);
        if(sum<4) ed.putBoolean("animals1", true);
        ed.apply();
    }
}
