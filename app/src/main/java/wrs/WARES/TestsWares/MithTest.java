...
public class MithTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mith_test);
        checked=true;
        question = (TextView) findViewById(R.id.question1);
        answers = (ListView) findViewById(R.id.answers1);

        questions = getResources().getStringArray(R.array.mithQ);
        answers1 = getResources().getStringArray(R.array.mithAns1);
        answers2 = getResources().getStringArray(R.array.mithAns2);
        answers3 = getResources().getStringArray(R.array.mithAns3);
        answers4 = getResources().getStringArray(R.array.mithAns4);
        answers5 = getResources().getStringArray(R.array.mithAns5);
        answers6 = getResources().getStringArray(R.array.mithAns6);
        answers7 = getResources().getStringArray(R.array.mithAns7);
        answers8 = getResources().getStringArray(R.array.mithAns8);
        answers9 = getResources().getStringArray(R.array.mithAns9);
        answers10 = getResources().getStringArray(R.array.mithAns10);
    ...
    protected void onPause() {
        ...
        if(sum>=8) ed.putBoolean("mith3", true);
        if(sum<8&&sum>=5) ed.putBoolean("mith2", true);
        if(sum<5) ed.putBoolean("mith1", true);
        ed.apply();
    }
}
