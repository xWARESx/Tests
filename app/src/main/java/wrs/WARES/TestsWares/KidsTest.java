...
public class KidsTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kids_test);
        checked=true;
        question = (TextView) findViewById(R.id.question1);
        answers = (ListView) findViewById(R.id.answers1);

        questions = getResources().getStringArray(R.array.kidsQ);
        answers1 = getResources().getStringArray(R.array.kidsAns1);
        answers2 = getResources().getStringArray(R.array.kidsAns2);
        answers3 = getResources().getStringArray(R.array.kidsAns3);
        answers4 = getResources().getStringArray(R.array.kidsAns4);
        answers5 = getResources().getStringArray(R.array.kidsAns5);
        answers6 = getResources().getStringArray(R.array.kidsAns6);
        answers7 = getResources().getStringArray(R.array.kidsAns7);
        answers8 = getResources().getStringArray(R.array.kidsAns8);
        answers9 = getResources().getStringArray(R.array.kidsAns9);

        res1 = getString(R.string.kidsRes1);
        res2 = getString(R.string.kidsRes2);
        res3 = getString(R.string.kidsRes3);
    ...
    protected void onPause() {
        ...
        if(sum>=7) ed.putBoolean("kids3", true);
        if(sum<7&&sum>=4) ed.putBoolean("kids2", true);
        if(sum<4) ed.putBoolean("kids1", true);
        ed.apply();
    }
}
