...
public class CatsTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cats_test);
        checked=true;
        question = (TextView) findViewById(R.id.question1);
        answers = (ListView) findViewById(R.id.answers1);

        questions = getResources().getStringArray(R.array.catsQ);
        answers1 = getResources().getStringArray(R.array.catsAns1);
        answers2 = getResources().getStringArray(R.array.catsAns2);
        answers3 = getResources().getStringArray(R.array.catsAns3);
        answers4 = getResources().getStringArray(R.array.catsAns4);
        answers5 = getResources().getStringArray(R.array.catsAns5);
        answers6 = getResources().getStringArray(R.array.catsAns6);
        answers7 = getResources().getStringArray(R.array.catsAns7);
        answers8 = getResources().getStringArray(R.array.catsAns8);

        res1 = getString(R.string.catsRes1);
        res2 = getString(R.string.catsRes2);
        res3 = getString(R.string.catsRes3);
    ...
    private void checkAnswer1(){
        ...
        if(q==8){
            ...
            if(sum<6&&sum>=3) intent1.putExtra("text", res2);
    ...
    protected void onPause() {
        ...
        if(sum>=6) ed.putBoolean("cats3", true);
        if(sum<6&&sum>=3) ed.putBoolean("cats2", true);
        if(sum<3) ed.putBoolean("cats1", true);
        ed.apply();
    }
}
