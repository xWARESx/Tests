...
public class WildNatureTest extends AppCompatActivity {
    ...
    int res = R.drawable.wild_nature_res;
    String res1;
    String res2;
    String res3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wild_nature_test);
        checked=true;
        question = (TextView) findViewById(R.id.question1);
        answers = (ListView) findViewById(R.id.answers1);

        questions = getResources().getStringArray(R.array.wildQ);
        answers1 = getResources().getStringArray(R.array.wildAns1);
        answers2 = getResources().getStringArray(R.array.wildAns2);
        answers3 = getResources().getStringArray(R.array.wildAns3);
        answers4 = getResources().getStringArray(R.array.wildAns4);
        answers5 = getResources().getStringArray(R.array.wildAns5);
        answers6 = getResources().getStringArray(R.array.wildAns6);
        answers7 = getResources().getStringArray(R.array.wildAns7);
        answers8 = getResources().getStringArray(R.array.wildAns8);
        answers9 = getResources().getStringArray(R.array.wildAns9);
        answers10 = getResources().getStringArray(R.array.wildAns10);
        answers11 = getResources().getStringArray(R.array.wildAns11);

        res1 = getString(R.string.wildRes1);
        res2 = getString(R.string.wildRes2);
        res3 = getString(R.string.wildRes3);
    ...
    private void checkAnswer1(){
        ...
        if(q==11){
            ...
            if(sum<9&&sum>=7) intent1.putExtra("text", res2);
    ...
    private void checkAnswer2() {
        ...
        if(q==11){
            Intent intent1 = new Intent(this, Results2.class);
            intent1.putExtra("image", res);
            if(sum>=10) intent1.putExtra("text", res3);
            if(sum<10&&sum>=8) intent1.putExtra("text", res2);
    ...
    protected void onPause() {
        ...
        if(sum>=10) ed.putBoolean("wild3", true);
        if(sum<10&&sum>=8) ed.putBoolean("wild2", true);
        if(sum<8) ed.putBoolean("wild1", true);
        ed.apply();
    }
}
