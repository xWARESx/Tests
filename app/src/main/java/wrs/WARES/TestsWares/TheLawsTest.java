...
public class TheLawsTest extends AppCompatActivity {
    ...
    int res = R.drawable.the_laws_res;
    String res1;
    String res2;
    String res3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_the_laws_test);
        checked=true;
        question = (TextView) findViewById(R.id.question1);
        answers = (ListView) findViewById(R.id.answers1);

        questions = getResources().getStringArray(R.array.thelawsQ);
        answers1 = getResources().getStringArray(R.array.thelawsAns1);
        answers2 = getResources().getStringArray(R.array.thelawsAns2);
        answers3 = getResources().getStringArray(R.array.thelawsAns3);
        answers4 = getResources().getStringArray(R.array.thelawsAns4);
        answers5 = getResources().getStringArray(R.array.thelawsAns5);
        answers6 = getResources().getStringArray(R.array.thelawsAns6);
        answers7 = getResources().getStringArray(R.array.thelawsAns7);
        answers8 = getResources().getStringArray(R.array.thelawsAns8);
        answers9 = getResources().getStringArray(R.array.thelawsAns9);

        res1 = getString(R.string.thelawsRes1);
        res2 = getString(R.string.thelawsRes2);
        res3 = getString(R.string.thelawsRes3);
    ...
    private void checkAnswer3() {
        ...
        if(q==9){
            ...
            if(sum<7&&sum>=3) intent1.putExtra("text", res2);
    ...
    protected void onPause() {
        ...
        if(sum>=7) ed.putBoolean("laws3", true);
        if(sum<7&&sum>=3) ed.putBoolean("laws2", true);
        if(sum<3) ed.putBoolean("laws1", true);
        ed.apply();
    }
}
