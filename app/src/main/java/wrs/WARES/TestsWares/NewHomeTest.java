...
public class NewHomeTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_home_test);
        checked=true;
        question = (TextView) findViewById(R.id.question1);
        answers = (ListView) findViewById(R.id.answers1);

        questions = getResources().getStringArray(R.array.homeQ);
        answers1 = getResources().getStringArray(R.array.homeAns);

        res1 = getString(R.string.homeRes1);
        res2 = getString(R.string.homeRes2);
        res3 = getString(R.string.homeRes3);
        res4 = getString(R.string.homeRes4);
