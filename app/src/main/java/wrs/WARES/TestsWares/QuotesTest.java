...
public class QuotesTest extends AppCompatActivity {
    ...
    int res = R.drawable.quotes_res1;
    String res1;
    String res2;
    String res3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quotes_test);
        checked=true;
        question = (TextView) findViewById(R.id.question1);
        answers = (ListView) findViewById(R.id.answers1);

        questions = getResources().getStringArray(R.array.quotesQ);
        answers1 = getResources().getStringArray(R.array.quotesAns1);
        answers2 = getResources().getStringArray(R.array.quotesAns2);
        answers3 = getResources().getStringArray(R.array.quotesAns3);
        answers4 = getResources().getStringArray(R.array.quotesAns4);
        answers5 = getResources().getStringArray(R.array.quotesAns5);
        answers6 = getResources().getStringArray(R.array.quotesAns6);
        answers7 = getResources().getStringArray(R.array.quotesAns7);
        answers8 = getResources().getStringArray(R.array.quotesAns8);
        answers9 = getResources().getStringArray(R.array.quotesAns9);
        answers10 = getResources().getStringArray(R.array.quotesAns10);

        res1 = getString(R.string.quotesRes1);
        res2 = getString(R.string.quotesRes2);
        res3 = getString(R.string.quotesRes3);
    ...
    protected void onPause() {
        ...
        if(sum>=7) ed.putBoolean("quotes3", true);
        if(sum<7&&sum>=4) ed.putBoolean("quotes2", true);
        if(sum<4) ed.putBoolean("quotes1", true);
        ed.apply();
    }
}
