...
public class MathTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions = getResources().getStringArray(R.array.mathQ);
        answers1 = getResources().getStringArray(R.array.mathAns1);
        answers2 = getResources().getStringArray(R.array.mathAns2);
        answers3 = getResources().getStringArray(R.array.mathAns3);
        answers4 = getResources().getStringArray(R.array.mathAns4);
        answers5 = getResources().getStringArray(R.array.mathAns5);
        answers6 = getResources().getStringArray(R.array.mathAns6);
        answers7 = getResources().getStringArray(R.array.mathAns7);

        res1 = getString(R.string.mathRes1);
        res2 = getString(R.string.mathRes2);
        res3 = getString(R.string.mathRes3);
    ...
    protected void onPause() {
        ...
        if(sum>=6) ed.putBoolean("math3", true);
        if(sum<6&&sum>=4) ed.putBoolean("math2", true);
        if(sum<4) ed.putBoolean("math1", true);
        ed.apply();
    }
}
