...
public class Mith2Test extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mith2_test);
        checked=true;
        question = (TextView) findViewById(R.id.question1);
        answers = (ListView) findViewById(R.id.answers1);

        questions = getResources().getStringArray(R.array.mith2Q);
        answers1 = getResources().getStringArray(R.array.mith2Ans1);
        answers2 = getResources().getStringArray(R.array.mith2Ans2);
        answers3 = getResources().getStringArray(R.array.mith2Ans3);
        answers4 = getResources().getStringArray(R.array.mith2Ans4);
        answers5 = getResources().getStringArray(R.array.mith2Ans5);
        answers6 = getResources().getStringArray(R.array.mith2Ans6);
        answers7 = getResources().getStringArray(R.array.mith2Ans7);
        answers8 = getResources().getStringArray(R.array.mith2Ans8);
        answers9 = getResources().getStringArray(R.array.mith2Ans9);
        answers10 = getResources().getStringArray(R.array.mith2Ans10);

        res1 = getString(R.string.mith2Res1);
        res2 = getString(R.string.mith2Res2);
        res3 = getString(R.string.mith2Res3);
    ...
    protected void onPause() {
        ...
        if(sum>=8) ed.putBoolean("mith23", true);
        if(sum<8&&sum>=5) ed.putBoolean("mith22", true);
        if(sum<5) ed.putBoolean("mith21", true);
        ed.apply();
    }
}
