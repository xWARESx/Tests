...
public class ZolTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zol_test);
        checked=true;
        question = (TextView) findViewById(R.id.question1);
        answers = (ListView) findViewById(R.id.answers1);

        questions = getResources().getStringArray(R.array.zolQ);
        answers1 = getResources().getStringArray(R.array.zolAns);

        res1 = getString(R.string.zolRes1);
        res2 = getString(R.string.zolRes2);
        res3 = getString(R.string.zolRes3);
        res4 = getString(R.string.zolRes4);
