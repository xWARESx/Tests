...
public class ClassicTest extends AppCompatActivity {
    ...
    int res = R.drawable.classic_res3;
    String res1;
    String res2;
    String res3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions = getResources().getStringArray(R.array.classicQ);
        answers1 = getResources().getStringArray(R.array.classicAns1);
        answers2 = getResources().getStringArray(R.array.classicAns2);
        answers3 = getResources().getStringArray(R.array.classicAns3);
        answers4 = getResources().getStringArray(R.array.classicAns4);
        answers5 = getResources().getStringArray(R.array.classicAns5);
        answers6 = getResources().getStringArray(R.array.classicAns6);
        answers7 = getResources().getStringArray(R.array.classicAns7);
        answers8 = getResources().getStringArray(R.array.classicAns8);
        answers9 = getResources().getStringArray(R.array.classicAns9);
        answers10 = getResources().getStringArray(R.array.classicAns10);
        answers11 = getResources().getStringArray(R.array.classicAns11);
        answers12 = getResources().getStringArray(R.array.classicAns12);
        answers13 = getResources().getStringArray(R.array.classicAns13);
        answers14 = getResources().getStringArray(R.array.classicAns14);
        answers15 = getResources().getStringArray(R.array.classicAns15);
        answers16 = getResources().getStringArray(R.array.classicAns16);
        answers17 = getResources().getStringArray(R.array.classicAns17);

        res1 = getString(R.string.classicRes1);
        res2 = getString(R.string.classicRes2);
        res3 = getString(R.string.classicRes3);
    ...
    private void checkAnswer1(){
        ...
        if(q==17){
            ...
            if(sum>=15) intent1.putExtra("text", res3);
            if(sum<15&&sum>=8) intent1.putExtra("text", res2);
    ...
    private void updateAnswers(){
        switch (mCurrentIndex){
            ...
            case 15:
                ...
                return;
            case 16:
                ArrayAdapter<String> adapter17= new ArrayAdapter<>(this, R.layout.kosmos_lay, answers17);
    ...
    protected void onPause() {
        ...
        if(sum>=15) ed.putBoolean("classic3", true);
        if(sum<15&&sum>=8) ed.putBoolean("classic2", true);
        if(sum<8) ed.putBoolean("classic1", true);
        ed.apply();
    }
}
