...
public class BatTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bat_test);
        checked=true;
        question = (TextView) findViewById(R.id.question1);
        answers = (ListView) findViewById(R.id.answers1);

        questions = getResources().getStringArray(R.array.batQ);

        answers1 = getResources().getStringArray(R.array.batAns);

        res1 = getString(R.string.batRes1);
        res2 = getString(R.string.batRes2);
        res3 = getString(R.string.batRes3);
        res4 = getString(R.string.batRes4);
